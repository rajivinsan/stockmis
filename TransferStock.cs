...
namespace GST
{
    public partial class TransferStock : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else if (drpOffice.Text.Trim() == drpOffice1.Text.Trim())
            {
                MessageBox.Show("Select Differnet Office/Branch");
                return;
        ...
        private void showstock()
        {
            try
            {
                OleDbDataAdapter ad1 = new OleDbDataAdapter("Select * from stock WHERE  issuedto =" + drpOffice1.SelectedValue + " ", con);
        ...
        private void drpOffice1_SelectedIndexChanged(object sender, EventArgs e)
        {
